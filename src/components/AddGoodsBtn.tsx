  ...
  return (
    <>
      <Button 
        ...
        size="large"
        className="h-11 px-6 rounded-lg bg-[#6F4E37] border-none hover:!bg-[#8B5A2B] shadow-md shadow-[#6F4E37]/20 font-medium transition-all duration-300 flex items-center"
      >
        <span className="text-xl mr-1">+</span> 添加商品
      </Button>

      <Modal
        title={<div className="text-xl font-bold text-gray-800">添加新商品</div>}
